...
if(weather=="cold"){
    ...
    "<img src='./img1.png' class='card-img-top w-75 two w-25' alt='...'>" +
    "<div class='card-body'>" +
  ...
  "</div>"
    ...
    document.write(
     "<div class='card one mx-auto ' style='width: 12rem;'>" +
    "<img src='./img2.png' class='card-img-top w-75 two' alt='...'>" +
    "<div class='card-body'>" +
  ...
  "</div>"
    ...
    document.write(
     "<div class='card one mx-auto' style='width: 12rem;'>" +
    "<img src='./img3.png' class='card-img-top w-75 two' alt='...'>" +
    "<div class='card-body'>" +
  ...
  "</div>"
      ...
      document.write(
       "<div class='card one mx-auto' style='width: 12rem;'>" +
      "<img src='./img4.png' class='card-img-top w-75 two' alt='...'>" +
      "<div class='card-body'>" +
        "<h5 class='card-title three'>" + "Sunny" + "</h5>" +
  ...
  document.write(
   "<div class='card one mx-auto' style='width: 12rem;'>" +
  "<img src='./img5.png' class='card-img-top w-75 two' alt='...'>" +
  "<div class='card-body'>" +
